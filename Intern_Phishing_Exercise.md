...
This was an incredible learning opportunity for me. While nothing we did was new to me, I hadn't yet had a chance to participate in a full-scale phishing exercise from the perspective of the attacker. I learned how to conduct OSNIT, how to use tools like Defender's Attack Simulation, the approval and planning process surrounding the exercise, as well as after-action concepts like follow-up emails, education and training. 
